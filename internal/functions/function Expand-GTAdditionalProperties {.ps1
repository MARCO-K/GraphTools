function Expand-GTAdditionalProperties
{
    ...
    .EXAMPLE
    Get-MgGroupMember -GroupId 90daa3a7-7fed-4fa7-a979-db74bcd7cbd0  | Expand-GTAdditionalProperties

    .EXAMPLE
    Get-MgDirectoryObjectById -ids 34568a12-8862-45cf-afef-9582cd9871c6 | Expand-GTAdditionalProperties
    #>
    ...
    process
    {
        ...
        {
            $inputObject.AdditionalProperties.GetEnumerator() | ForEach-Object {
                $item = $_
